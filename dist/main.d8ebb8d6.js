...
function HashNavigation({
  ...
  const onHashChange = () => {
    ...
    if (newHash !== activeSlideHash) {
      const newIndex = swiper.getSlideIndex((0, _utils.elementChildren)(swiper.slidesEl, ".".concat(swiper.params.slideClass, "[data-hash=\"").concat(newHash, "\"], swiper-slide[data-hash=\"").concat(newHash, "\"]"))[0]);
...
},{"swiper":"../node_modules/swiper/swiper.esm.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
